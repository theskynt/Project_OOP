...
class Tea_Page:
    ...
    def __init__(self, top=None, arg1=None):
        ...
        self.Image_tea = tk.Label(self.top)
        self.Image_tea.place(relx=0.267, rely=0.014, height=195, width=266)
        self.Image_tea.configure(activebackground="#f9f9f9")
        self.Image_tea.configure(activeforeground="black")
        self.Image_tea.configure(anchor='w')
        self.Image_tea.configure(background="#d1c9ad")
        self.Image_tea.configure(borderwidth="45")
        self.Image_tea.configure(compound='left')
        self.Image_tea.configure(disabledforeground="#a3a3a3")
        self.Image_tea.configure(foreground="#d1c9ad")
        self.Image_tea.configure(highlightbackground="#d9d9d9")
        self.Image_tea.configure(highlightcolor="black")
        photo_location = f'./menu/{self.name}.png'
        global _img0
        _img0 = tk.PhotoImage(file=photo_location)
        self.Image_tea.configure(image=_img0)
        ...
        self.checkbox_4.configure(cursor="hand2")
        ...
        self.Frame2.configure(text='''EXTRA TOPPING''')
        self.Frame2.configure(background="#f2ebe3")
        self.Frame2.configure(highlightbackground="#d9d9d9")
        self.Frame2.configure(highlightcolor="black")

        self.Checkbutton_topping = tk.Checkbutton(self.Frame2)
        self.Checkbutton_topping.place(relx=0.926, rely=0.235, relheight=0.541
                , relwidth=0.057, bordermode='ignore')
        self.Checkbutton_topping.configure(activebackground="#ececec")
        self.Checkbutton_topping.configure(activeforeground="#000000")
        self.Checkbutton_topping.configure(anchor='w')
        self.Checkbutton_topping.configure(background="#f2ebe3")
        self.Checkbutton_topping.configure(compound='left')
        self.Checkbutton_topping.configure(cursor="hand2")
        self.Checkbutton_topping.configure(disabledforeground="#a3a3a3")
        self.Checkbutton_topping.configure(foreground="#000000")
        self.Checkbutton_topping.configure(highlightbackground="#d9d9d9")
        self.Checkbutton_topping.configure(highlightcolor="black")
        self.Checkbutton_topping.configure(justify='left')
        self.Checkbutton_topping.configure(variable=self.topping_check)

        self.Label3 = tk.Label(self.Frame2)
        self.Label3.place(relx=0.07, rely=0.482, height=27, width=244
                , bordermode='ignore')
        ...
        self.Label3.configure(text='''Add bubble (+10฿)''')

        self.Frame3 = tk.LabelFrame(self.top)
        self.Frame3.place(relx=0.05, rely=0.643, relheight=0.107, relwidth=0.9)
        self.Frame3.configure(relief='groove')
        self.Frame3.configure(font="-family {Comic Sans MS} -size 12 -underline 1")
        self.Frame3.configure(foreground="#400000")
        self.Frame3.configure(text='''STRAW''')
        self.Frame3.configure(background="#f2ebe3")
        self.Frame3.configure(highlightbackground="#d9d9d9")
        self.Frame3.configure(highlightcolor="black")

        self.Checkbutton_straw = tk.Checkbutton(self.Frame3)
        self.Checkbutton_straw.place(relx=0.926, rely=0.307, relheight=0.533
        ...
        self.Label4.place(relx=0.074, rely=0.467, height=24, width=164
                , bordermode='ignore')
        ...
        self.logo_icon.place(relx=0.01, rely=0.006, height=71, width=74)
    ...
    def open_payment_page(self):
        ...
        menu_chack = main.Menu_Tea

        try:
                menu_chack.selected_menu_tea(self.bubble, self.sugar, self.Combobox_blended.get(), self.straw)
                # with open('backend/receipt.json', 'w') as json_file:
                #         json.dump(data, json_file)
                self.top.destroy()
                payment_page.main_loop()
        except: 
                messagebox.showerror("Error", "Please choose sweetness .")
                print("error")
